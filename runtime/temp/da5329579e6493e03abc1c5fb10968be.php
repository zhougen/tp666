<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"E:\web\WWW\blog\public/../application/admin\view\tag\index.html";i:1500787855;s:58:"E:\web\WWW\blog\public/../application/admin\view\base.html";i:1500824058;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo url('add'); ?>">添加标签</a></li>
    </ul>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo url('admin/tag/add',['tag_id'=>$v['tag_id']]); ?>">编辑</a></li>
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $v['tag_id']; ?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
