<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\web\WWW\blog\public/../application/admin\view\link\index.html";i:1500991692;s:58:"E:\web\WWW\blog\public/../application/admin\view\base.html";i:1500824058;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo url('add'); ?>">添加友链</a></li>
    </ul>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo url('add',['link_id'=>$vo['link_id']]); ?>">编辑</a></li>
                                    <li class="divider"></li>
