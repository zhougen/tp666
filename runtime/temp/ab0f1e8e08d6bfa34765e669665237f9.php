<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\web\WWW\blog\public/../application/admin\view\category\index.html";i:1500712132;s:58:"E:\web\WWW\blog\public/../application/admin\view\base.html";i:1500824058;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo url('admin/category/add'); ?>">添加栏目</a></li>
    </ul>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo url('admin/category/addSon',['cate_id'=>$vo['cate_id']]); ?>">添加子类</a></li>
