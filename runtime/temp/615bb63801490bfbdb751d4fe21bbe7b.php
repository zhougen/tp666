<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"E:\web\WWW\blog\public/../application/index\view\index\index.html";i:1501123491;s:58:"E:\web\WWW\blog\public/../application/index\view\base.html";i:1501075645;}*/ ?>
...
<?php if(is_array($articleData) || $articleData instanceof \think\Collection || $articleData instanceof \think\Paginator): if( count($articleData)==0 ) : echo "" ;else: foreach($articleData as $key=>$vo): ?>
    ...
    <div class="_digest">
        <img src="__STATIC__/index/images/1.jpg"  class="img-responsive"/>
        <p>
