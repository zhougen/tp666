<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\web\WWW\blog\public/../application/admin\view\webset\index.html";i:1500995436;s:58:"E:\web\WWW\blog\public/../application/admin\view\base.html";i:1500824058;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" value="<?php echo $vo['webset_value']; ?>" onblur="changewebset(this,<?php echo $vo['webset_id']; ?>)">
                        </td>
                        <td><?php echo $vo['webset_desc']; ?></td>
                    </tr>
...
<script>
    ...
    function changewebset(obj,webset_id) {
          ...
          $.post("<?php echo url('edit'); ?>",{webset_id:webset_id,webset_value:web_value},function (res) {
